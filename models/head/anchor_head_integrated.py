...
class AnchorHeadSingleIntegrated(nn.Module):
    ...
    def get_cls_layer_loss(self, key_for_logging=None):
        ...
        if key_for_logging is None:
            tb_dict = {
                'rpn_loss_cls': cls_loss.item()
            }
        else:
            tb_dict = {
                'rpn_loss_cls_'+key_for_logging: cls_loss.item()
            }
    ...
    def get_box_reg_layer_loss(self, key_for_logging=None):
        ...
        if key_for_logging is None:
            ...
            tb_dict = {
                'rpn_loss_loc_'+key_for_logging: loc_loss.item()
            }
        ...
        if box_dir_cls_preds is not None:
            ...
            if key_for_logging is None:
                ...
                tb_dict['rpn_loss_dir_'+key_for_logging] = dir_loss.item()

        return box_loss, tb_dict

    def loss(self, dict_item, key_for_logging=None):
        cls_loss, tb_dict = self.get_cls_layer_loss(key_for_logging)
        box_loss, tb_dict_box = self.get_box_reg_layer_loss(key_for_logging)
        ...
        if key_for_logging is None:
            ...
            tb_dict['rpn_loss_'+key_for_logging] = rpn_loss.item()
    ...
    def forward(self, data_dict, key_features=None):
        ...
        if key_features is None:
            ...
            spatial_features_2d = key_features
