#!/usr/bin/env python3
"""Evaluate Seq1-only open-world online weather discovery and reuse."""
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=REPOSITORY_ROOT / "results/SceneDiscovery/OnlineWeatherDiscoveryV5",
    )
...
def main():
    ...
    run_dir = make_run_dir(args.output_root.expanduser().resolve(), "online_weather_v5")
    ...
    print("V5 Seq1-only weather calibration:")
    print(pd.DataFrame([calibration_payload]).to_string(index=False))
    print("\nV5 open-world online weather metrics across orders:")
    display = [
        "change_multiplier", "change_threshold", "match_threshold_ratio",
